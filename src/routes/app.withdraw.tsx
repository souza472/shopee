    ...
    <div className="max-w-md mx-auto">
      ...
      <div className="p-4">
        ...
        <div className="mt-4 text-xs text-muted-foreground space-y-1 leading-relaxed">
          ...
          <p>*2. Taxa única de R$ 5,00 apenas no primeiro saque. Depois, sem taxas.</p>
          <p>*3. Horário de atendimento financeiro: 7h às 19h.</p>
          <p>*4. Verifique o endereço da carteira do destinatário. Informações incorretas fazem os fundos não serem recebidos.</p>
        </div>
