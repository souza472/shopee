  ...
  return (
    <div className="max-w-md mx-auto">
      <header className="flex items-center justify-center px-4 pt-3 pb-2 relative">
        <h1 className="text-lg font-medium">Shopping Global</h1>
      ...
      <div className="mx-4 mt-4 rounded-2xl p-4 text-white shadow-lg" style={{ background: "linear-gradient(135deg, oklch(0.72 0.18 45), oklch(0.6 0.22 30))" }}>
